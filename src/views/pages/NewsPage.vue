<template>
  <BreadCumb route_name="Crypto news" />
      ...
      <div class="row">
                ...
                <div class="single-blog-area blog-style-2 mb-100">
                  ...
                  <div class="blog-content">
                    ...
                    <p>
                      ...
                      Sed faucibus mauris vitae urna consectetur, sit amet
                      maximus nisl sagittis.
                    </p>
              ...
              <div class="col-12">
                ...
                <div class="single-blog-area d-flex align-items-start">
                  ...
                  <div class="blog-content">
                    ...
                    <p>
                      Iaculis lacus vel, posuere ipsum. Sed faucibus mauris
                      vitae urna consectetur, sit amet maximus nisl sagittis. Ut
                      in iaculis enim.
                    </p>
                  </div>
                </div>
        ...
        <div class="col-12 col-lg-4">
          <div class="cryptos-blog-sidebar-area">
            ...
            <!-- Single Blog Area -->
            <div
              class="single-blog-area blog-style-3 d-flex align-items-center mb-15"
            >
              <!-- Thumbnail -->
              <div class="blog-thumbnail">
...
<script setup>
import BreadCumb from "../../components/UI/menu/BreadCumb.vue";
</script>
