                ...
                <div class="range_item">
                  ...
                  <span class="irs js-irs-0"
                    ><span class="irs"
                      ...
                      ><span
                        class="irs-to"
                        style="visibility: visible; left: 43.4783%"
                        >tk. 500</span
                      ><span
                        class="irs-single"
                        style="visibility: hidden; left: 15.5072%"
                        >tk. 0 - tk. 500</span
                      ></span
                    ><span class="irs-grid"></span
                    ><span
                      class="irs-bar"
                      style="left: 2.17391%; width: 47.8261%"
                    ></span
                    ><span
...
import { useAuction } from "@/stores/auction.js";

onMounted: () => {
  console.log(useAuction.auctions);
};
</script>
